...
router.post(
	...
	body("firstname").trim().isAlpha("en-US",{ignore: ["Ą","ą","Č","č","Ę","ę","Ė","ė","Į","į","Š","š","Ų","ų","Ū","ū"]}).escape().withMessage("First name must not contain numbers").isLength({min:2, max:25}).withMessage("First name must contain min 2 characters and not be longer than 25 characters"),
	body("lastname").trim().isAlpha("en-US",{ignore: ["Ą","ą","Č","č","Ę","ę","Ė","ė","Į","į","Š","š","Ų","ų","Ū","ū"]}).escape().withMessage("Last name must not contain numbers").isLength({min:2, max:25}).withMessage("Lastname must contain min 2 characters and not be longer than 25 characters"),
