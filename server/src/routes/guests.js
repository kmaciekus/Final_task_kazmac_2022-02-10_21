...
router.post(
	...
	body(["firstname","lastname"]).trim().isAlpha("en-US",{ignore: ["Ą","ą","Č","č","Ę","ę","Ė","ė","Į","į","Š","š","Ų","ų","Ū","ū"]}).escape().withMessage("First and last name must contain only letters").isLength({min:2, max:25}).withMessage("First name must contain min 2 characters and not be longer than 25 characters"),
